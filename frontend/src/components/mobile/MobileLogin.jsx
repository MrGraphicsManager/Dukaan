...
import { ArrowLeft, Eye, EyeOff, Lock, Phone, Store, CheckCircle2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-white max-w-md mx-auto flex flex-col justify-between p-6 select-none animate-in fade-in duration-200">
      ...
      <div>
        ...
        <button
          ...
          className="w-full py-3 px-4 border border-slate-200 rounded-xl bg-white hover:bg-slate-50 font-bold text-sm text-slate-700 flex items-center justify-center gap-3 transition-colors cursor-pointer shadow-xs active:scale-[0.99]"
        >
