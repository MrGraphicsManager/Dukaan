...
const NAV = [
  { to: "/nexoraos/admin/dashboard", icon: LayoutDashboard, label: "Overview" },
  { to: "/nexoraos/admin/cafes", icon: Store, label: "Cafés" },
  { to: "/nexoraos/admin/invoices", icon: Receipt, label: "Invoices" },
];
    ...
    <>
      ...
      <div className="p-3 border-t border-[#3D312A]">
        <div className="flex items-center gap-3 px-2 py-2">
          ...
          <button data-testid="admin-logout-button" onClick={()=>{logout();nav("/nexoraos/admin");}} className="p-2 rounded-lg hover:bg-[#2E2521] text-[#9E8E81]"><LogOut className="w-4 h-4"/></button>
        </div>
      </div>
    </>
  );
