...
export default function AdminCafeDetail() {
  ...
  return (
    <div className="space-y-6" data-testid="admin-cafe-detail-page">
      <Link to="/nexoraos/admin/cafes" className="inline-flex items-center gap-2 text-sm text-[#9E8E81] hover:text-[#F7F2EC]"><ArrowLeft className="w-4 h-4"/> Back to cafés</Link>
