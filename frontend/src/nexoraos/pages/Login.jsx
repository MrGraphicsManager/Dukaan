  ...
  return (
    <AuthShell title="Sign in to NexoraOS" subtitle="Café operations, simplified.">
      <form onSubmit={submit} className="space-y-4">
        ...
        <div className="flex justify-end"><Link to="/nexoraos/forgot-password" data-testid="login-forgot-link" className="text-xs text-[#C85A32] hover:underline font-medium">Forgot password?</Link></div>
      ...
      <div className="mt-6 text-sm text-[#6B5A52] text-center">New to NexoraOS? <Link to="/nexoraos/signup" data-testid="login-signup-link" className="text-[#C85A32] font-semibold hover:underline">Create account</Link></div>
    </AuthShell>
  );
}
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] grain flex items-center justify-center p-6">
      <div className="w-full max-w-md relative z-10">
        <Link to="/nexoraos" className="flex items-center gap-2.5 justify-center mb-8">
